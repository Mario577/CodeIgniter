...
<body>
    ...
    <script>
        $('#Guardar').click(function() {
            ...
            var _datos = $('#form_1');
            $.ajax({
                url: 'http://localhost/CodeIgniter/index.php/Listas/guardar_by_ajax2',
                ...
                success: function(reshhh) {
                    ...
                    if (_respuesta.respuesta == true) {
                        ...
                        var informacion = _respuesta.tabla;
                        // informacion.slice(1).forEach(function() {
                        //     //    informacion = $("#tabla1>tbody").append("<tr><td>" + $('#dui').val() + "</td><td>" + $('#nombre').val() + "</td><td>" + $('#edad').val() + "</td></tr>");
                        //     // console.log(informacion[index])
                        // });
